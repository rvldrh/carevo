...
export default function ChangePasswordPage() {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#4E61F6] overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col md:flex-row w-full max-w-[1054px] mx-4 md:mx-8 rounded-[20px] shadow-2xl overflow-hidden min-h-[500px] md:min-h-[720px] bg-white">
        <ChangePasswordForm />
