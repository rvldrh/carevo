...
export default function BootcampCard({ bootcamp }: { bootcamp: Bootcamp }) {
  ...
  return (
    <div className="w-56 h-72 bg-white rounded-[20px] p-3 flex flex-col gap-2 shadow-sm border border-gray-100 hover:scale-105 transition-transform cursor-pointer">
