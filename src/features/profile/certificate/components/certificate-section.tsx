import CertificateList from "@/features/profile/certificate/components/certificate-list";
import CertificateActionsClient from "@/features/profile/certificate/components/certificate-action-client";
